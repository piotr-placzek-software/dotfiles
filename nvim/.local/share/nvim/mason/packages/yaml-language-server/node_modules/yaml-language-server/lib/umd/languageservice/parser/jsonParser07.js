...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/objects", "../utils/schemaUtils", "vscode-json-languageservice", "vscode-nls", "vscode-uri", "vscode-languageserver-types", "../utils/arrUtils", "../utils/strings", "../services/yamlSchemaService", "../utils/math"], factory);
    }
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        function _validateNode() {
            ...
            if ((0, objects_1.isDefined)(schema.const)) {
                const val = getNodeValue(node);
                if (!(0, objects_1.equals)(val, schema.const) && !isAutoCompleteEqualMaybe(callFromAutoComplete, node, val, schema.const)) {
                    validationResult.problems.push({
                        location: { offset: node.offset, length: node.length },
                        severity: vscode_languageserver_types_1.DiagnosticSeverity.Warning,
                        code: vscode_json_languageservice_1.ErrorCode.EnumValueMismatch,
